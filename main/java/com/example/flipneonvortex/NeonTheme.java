...
public class NeonTheme {
    ...
    private static void applyRecursively(android.view.View view, boolean isDark) {
        if (view instanceof android.view.ViewGroup) {
            ...
            // Also don't change if tag is "fixed_color" (e.g., custom UI backgrounds)
            boolean isFixedColor = "fixed_color".equals(view.getTag());
            if (!(view instanceof android.widget.Button) && !isFixedColor) {
