...
public class ObstacleManager {
    ...
    public static class Obstacle {
        ...
        public boolean playerCollide(Player player) {
            // Hitbox reduction
            int padding = 10;
            Rect hitbox = new Rect(rectangle.left + padding, rectangle.top + padding, rectangle.right - padding, rectangle.bottom - padding);

            return Rect.intersects(hitbox, new Rect(
